...
# i think I did this. I made the file and coppied and pasted the above code into it. Im not sure if the code needs to be edited - benji
...
# prettyh sure I did this too on an earlier date, but it may need to be done again if problems arise. 
...
### 3. [Optional] - Download HD resources
 ...
 #i dont want to do this ^. it will slow the simulation down. Could do in the future if we want to improve quality. 
